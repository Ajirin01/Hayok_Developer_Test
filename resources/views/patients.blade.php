...
@section('content')
    <div class="content">
        <div class="row">
            ...
            <div class="col-sm-4 col-3 text-center m-b-20">
                <!-- <button type="submit" class="btn btn btn-primary btn-rounded">Filter</button> -->

                <!-- <form action="">
                    <label for="ibm">IBM: </label><span><input type="text" name="ibm-min" id="" style="width: 20px"><input style="width: 20px" type="text" name="ibm-max" id=""></span><input type="checkbox" name="ibm" id="" >
                    <label for="age">Age: </label><span><input type="text" name="ibm-min" id="" style="width: 20px"><input style="width: 20px" type="text" name="ibm-max" id=""></span><input type="checkbox" name="age" id="" >
                    <label for="gender">Gender: </label><span><input type="text" name="ibm-min" id="" style="width: 20px"><input style="width: 20px" type="text" name="ibm-max" id=""></span><input type="checkbox" name="gender" id="" >
                    <button type="submit" class="btn btn btn-primary btn-rounded">Filter</button> -->
                    <!-- <h4 class="page-title">Filter</h4> -->
                    <!-- <select name="filter" id="" class="form-select" multiple aria-label="Select Filters">
                        <option value="">IMB</option>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="table-responsive">
                    <table id="example1" class="table table-border table-striped custom-table datatable mb-0">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Age</th>
                        ...
                        <tbody>
                            <tr>
                                <td><a href="profile.html"><img width="28" height="28" src="assets/img/user.jpg" class="rounded-circle m-r-5" alt=""> Jennifer Robinson</a></td>
                                <td>35</td>
                                ...
                                <td class="text-right">
                                    <div class="dropdown dropdown-action">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item" href="add-encounter.html"><i class="fa fa-pencil m-r-5"></i> Encounter</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
